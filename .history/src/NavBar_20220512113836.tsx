...
import './NavBar.scss';
import { Sidenav } from '@finastra/sidenav';
...
type CustomElement<T, K extends string> = Partial<T & DOMAttributes<T> & { children: any } & <CustomEvents></CustomEvents><`on${K}`>>;

declare global {
  namespace JSX {
    interface IntrinsicElements {
      'fds-sidenav': CustomElement<Sidenav, any>;
      'fds-app-bar': CustomElement<AppBar, any>;
      'mwc-icon-button': any;
